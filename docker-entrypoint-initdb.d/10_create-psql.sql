...
alter table ian_mpps_task add constraint UK_4yckwjdnu0n1dw2hp80mn4cq  unique (mpps_fk);
create index UK_dahukstpq857pq02s5qib8m3 on ian_mpps_task (device_name);
alter table ian_study_task add constraint UK_p9o7rk3m383c9k4u7kh2gfdkb  unique (study_iuid);
create index UK_ifcq2e0qu8is172pry180ipuc on ian_study_task (device_name, scheduled_time);
...
alter table ian_mpps_task add constraint FK_4yckwjdnu0n1dw2hp80mn4cq foreign key (mpps_fk) references mpps;
