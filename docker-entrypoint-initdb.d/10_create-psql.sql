...
create table series (pk int8 not null, body_part varchar(255) not null, created_time timestamp not null, expiration_date varchar(255), failed_retrieves int4 not null, failed_iuids varchar(4000), institution varchar(255) not null, department varchar(255) not null, laterality varchar(255) not null, modality varchar(255) not null, pps_cuid varchar(255) not null, pps_iuid varchar(255) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, rejection_state int4 not null, series_custom1 varchar(255) not null, series_custom2 varchar(255) not null, series_custom3 varchar(255) not null, series_desc varchar(255) not null, series_iuid varchar(255) not null, series_no int4 not null, src_aet varchar(255), station_name varchar(255) not null, updated_time timestamp not null, version int8, dicomattrs_fk int8 not null, inst_code_fk int8, perf_phys_name_fk int8, study_fk int8 not null, primary key (pk));
...
create table study_ext_retrieve_aet (pk int8 not null, retrieve_aet varchar(255) not null, view_id varchar(255) not null, study_fk int8 not null, primary key (pk));
