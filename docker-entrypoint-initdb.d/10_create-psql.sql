...
create table export_task (pk int8 not null, created_time timestamp not null, device_name varchar(255) not null, error_msg varchar(255), exporter_id varchar(255) not null, msg_id varchar(255), modalities varchar(255), num_failures int4 not null, num_instances int4, outcome_msg varchar(255), proc_end_time timestamp, proc_start_time timestamp, scheduled_time timestamp not null, series_iuid varchar(255) not null, sop_iuid varchar(255) not null, msg_status int4 not null, study_iuid varchar(255) not null, updated_time timestamp not null, version int8, primary key (pk));
