...
create table retrieve_task (pk int8 not null, batch_id varchar(255), completed int4 not null, created_time timestamp not null, destination_aet varchar(255) not null, device_name varchar(255) not null, error_comment varchar(255), failed int4 not null, local_aet varchar(255) not null, queue_name varchar(255) not null, remaining int4 not null, remote_aet varchar(255) not null, series_iuid varchar(255), sop_iuid varchar(255), status_code int4 not null, study_iuid varchar(255) not null, updated_time timestamp not null, warning int4 not null, queue_msg_fk int8, primary key (pk));
