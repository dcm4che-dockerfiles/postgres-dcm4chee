...
create table hl7psu_task (pk int8 not null, accession_no varchar(255), aet varchar(255) not null, created_time timestamp not null, device_name varchar(255) not null, pps_status int4, scheduled_time timestamp, series_iuid varchar(255), study_iuid varchar(255), mpps_fk int8, primary key (pk));
...
create table instance_req (pk int8 not null, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), req_proc_id varchar(255) not null, req_service varchar(255) not null, sps_id varchar(255) not null, study_iuid varchar(255) not null, req_phys_name_fk int8, instance_fk int8, primary key (pk));
create table location (pk int8 not null, created_time timestamp not null, digest varchar(255), multi_ref int4, object_type int4 not null, object_size int8 not null, status int4 not null, storage_id varchar(255) not null, storage_path varchar(255) not null, tsuid varchar(255), uidmap_fk int8, instance_fk int8, primary key (pk));
...
create table mpps (pk int8 not null, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), created_time timestamp not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, sop_iuid varchar(255) not null, pps_status int4 not null, study_iuid varchar(255) not null, updated_time timestamp not null, version int8, dicomattrs_fk int8 not null, discreason_code_fk int8, patient_fk int8 not null, primary key (pk));
create table mwl_item (pk int8 not null, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), admission_id varchar(255) not null, admid_entity_id varchar(255), admid_entity_uid varchar(255), admid_entity_uid_type varchar(255), created_time timestamp not null, institution varchar(255) not null, department varchar(255) not null, local_aet varchar(255) not null, modality varchar(255) not null, req_proc_id varchar(255) not null, sps_id varchar(255) not null, sps_start_date varchar(255) not null, sps_start_time varchar(255) not null, sps_status int4 not null, study_iuid varchar(255) not null, updated_time timestamp not null, version int8, dicomattrs_fk int8 not null, inst_code_fk int8, dept_code_fk int8, patient_fk int8 not null, perf_phys_name_fk int8, primary key (pk));
...
create table patient_id (pk int8 not null, pat_id varchar(255) not null, pat_id_type_code varchar(255), entity_id varchar(255), entity_uid varchar(255), entity_uid_type varchar(255), version int8, primary key (pk));
...
create table series_req (pk int8 not null, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), req_proc_id varchar(255) not null, req_service varchar(255) not null, sps_id varchar(255) not null, study_iuid varchar(255) not null, req_phys_name_fk int8, series_fk int8, primary key (pk));
