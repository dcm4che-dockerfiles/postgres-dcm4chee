...
create table person_name (pk int8 not null, alphabetic_name varchar(255) not null, ideographic_name varchar(255) not null, phonetic_name varchar(255) not null, primary key (pk));
...
create table series (pk int8 not null, body_part varchar(255) not null, completeness int4 not null, compress_failures int4 not null, compress_params varchar(255), compress_time timestamp, compress_tsuid varchar(255), created_time timestamp not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state int4 not null, ext_retrieve_aet varchar(255), failed_retrieves int4 not null, stgver_failures int4 not null, inst_purge_state int4 not null, inst_purge_time timestamp, institution varchar(255) not null, department varchar(255) not null, laterality varchar(255) not null, metadata_update_time timestamp, metadata_update_failures int4 not null, modality varchar(255) not null, pps_cuid varchar(255) not null, pps_iuid varchar(255) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, receiving_aet varchar(255), receiving_pres_addr varchar(255), rejection_state int4 not null, sending_aet varchar(255), sending_pres_addr varchar(255), series_custom1 varchar(255) not null, series_custom2 varchar(255) not null, series_custom3 varchar(255) not null, series_desc varchar(255) not null, series_iuid varchar(255) not null, series_no int4, series_size int8 not null, sop_cuid varchar(255) not null, station_name varchar(255) not null, stgver_time timestamp, tsuid varchar(255) not null, updated_time timestamp not null, version int8, dicomattrs_fk int8 not null, inst_code_fk int8, dept_code_fk int8, metadata_fk int8, perf_phys_name_fk int8, study_fk int8 not null, primary key (pk));
