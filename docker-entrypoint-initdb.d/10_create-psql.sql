...
create table hl7psu_task (pk int8 not null, aet varchar(255) not null, created_time timestamp not null, device_name varchar(255) not null, pps_status int4, scheduled_time timestamp, series_iuid varchar(255), study_iuid varchar(255), mpps_fk int8, primary key (pk));
