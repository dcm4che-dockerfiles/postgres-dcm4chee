...
create table diff_task_attrs (diff_task_fk int8 not null, dicomattrs_fk int8 not null);
create table export_task (pk int8 not null, batch_id varchar(255), created_time timestamp not null, device_name varchar(255) not null, exporter_id varchar(255) not null, modalities varchar(255), num_instances int4, scheduled_time timestamp, series_iuid varchar(255) not null, sop_iuid varchar(255) not null, study_iuid varchar(255) not null, updated_time timestamp not null, version int8, queue_msg_fk int8, primary key (pk));
create table global_subscription (pk int8 not null, deletion_lock boolean not null, subscriber_aet varchar(255) not null, matchkeys_fk int8, primary key (pk));
create table hl7psu_task (pk int8 not null, aet varchar(255) not null, created_time timestamp not null, device_name varchar(255) not null, scheduled_time timestamp, series_iuid varchar(255), study_iuid varchar(255), mpps_fk int8, primary key (pk));
...
create table metadata (pk int8 not null, created_time timestamp not null, digest varchar(255), object_size int8 not null, status int4 not null, storage_id varchar(255) not null, storage_path varchar(255) not null, primary key (pk));
...
create table mwl_item (pk int8 not null, accession_no varchar(255) not null, admission_id varchar(255) not null, created_time timestamp not null, institution varchar(255) not null, department varchar(255) not null, local_aet varchar(255) not null, modality varchar(255) not null, req_proc_id varchar(255) not null, sps_id varchar(255) not null, sps_start_date varchar(255) not null, sps_start_time varchar(255) not null, sps_status int4 not null, study_iuid varchar(255) not null, updated_time timestamp not null, version int8, dicomattrs_fk int8 not null, inst_code_fk int8, dept_code_fk int8, accno_issuer_fk int8, admid_issuer_fk int8, patient_fk int8 not null, perf_phys_name_fk int8, primary key (pk));
create table patient (pk int8 not null, created_time timestamp not null, failed_verifications int4 not null, num_studies int4 not null, pat_birthdate varchar(255) not null, pat_custom1 varchar(255) not null, pat_custom2 varchar(255) not null, pat_custom3 varchar(255) not null, pat_sex varchar(255) not null, updated_time timestamp not null, verification_status int4 not null, verification_time timestamp, version int8, dicomattrs_fk int8 not null, merge_fk int8, patient_id_fk int8, pat_name_fk int8, resp_person_fk int8, primary key (pk));
...
create table person_name (pk int8 not null, alphabetic_name varchar(255) not null, family_name varchar(255), given_name varchar(255), i_family_name varchar(255), i_given_name varchar(255), i_middle_name varchar(255), ideographic_name varchar(255) not null, i_name_prefix varchar(255), i_name_suffix varchar(255), middle_name varchar(255), name_prefix varchar(255), name_suffix varchar(255), p_family_name varchar(255), p_given_name varchar(255), p_middle_name varchar(255), phonetic_name varchar(255) not null, p_name_prefix varchar(255), p_name_suffix varchar(255), primary key (pk));
create table queue_msg (pk int8 not null, batch_id varchar(255), created_time timestamp not null, device_name varchar(255) not null, error_msg varchar(255), msg_body bytea not null, msg_id varchar(255) not null, msg_props varchar(4000) not null, num_failures int4 not null, outcome_msg varchar(255), priority int4 not null, proc_end_time timestamp, proc_start_time timestamp, queue_name varchar(255) not null, scheduled_time timestamp not null, msg_status int4 not null, updated_time timestamp not null, version int8, primary key (pk));
create table rejected_instance (pk int8 not null, created_time timestamp not null, series_iuid varchar(255) not null, sop_cuid varchar(255) not null, sop_iuid varchar(255) not null, study_iuid varchar(255) not null, reject_code_fk int8, primary key (pk));
create table rel_study_pcode (study_fk int8 not null, pcode_fk int8 not null);
create table rel_ups_perf_code (ups_fk int8 not null, perf_code_fk int8 not null);
create table retrieve_task (pk int8 not null, batch_id varchar(255), completed int4 not null, created_time timestamp not null, destination_aet varchar(255) not null, device_name varchar(255) not null, error_comment varchar(255), failed int4 not null, local_aet varchar(255) not null, queue_name varchar(255) not null, remaining int4 not null, remote_aet varchar(255) not null, scheduled_time timestamp, series_iuid varchar(255), sop_iuid varchar(255), status_code int4 not null, study_iuid varchar(255) not null, updated_time timestamp not null, warning int4 not null, queue_msg_fk int8, primary key (pk));
create table series (pk int8 not null, body_part varchar(255) not null, completeness int4 not null, compress_failures int4 not null, compress_params varchar(255), compress_time timestamp, compress_tsuid varchar(255), created_time timestamp not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state int4 not null, ext_retrieve_aet varchar(255), failed_retrieves int4 not null, stgver_failures int4 not null, inst_purge_state int4 not null, inst_purge_time timestamp, institution varchar(255) not null, department varchar(255) not null, laterality varchar(255) not null, metadata_update_time timestamp, metadata_update_failures int4 not null, modality varchar(255) not null, pps_cuid varchar(255) not null, pps_iuid varchar(255) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, rejection_state int4 not null, series_custom1 varchar(255) not null, series_custom2 varchar(255) not null, series_custom3 varchar(255) not null, series_desc varchar(255) not null, series_iuid varchar(255) not null, series_no int4, series_size int8 not null, sop_cuid varchar(255) not null, src_aet varchar(255), station_name varchar(255) not null, stgver_time timestamp, tsuid varchar(255) not null, updated_time timestamp not null, version int8, dicomattrs_fk int8 not null, inst_code_fk int8, dept_code_fk int8, metadata_fk int8, perf_phys_name_fk int8, study_fk int8 not null, primary key (pk));
...
create table stgcmt_result (pk int8 not null, batch_id varchar(255), created_time timestamp not null, device_name varchar(255) not null, exporter_id varchar(255), msg_id varchar(255), num_failures int4, num_instances int4, series_iuid varchar(255), sop_iuid varchar(255), stgcmt_status int4 not null, study_iuid varchar(255) not null, transaction_uid varchar(255) not null, updated_time timestamp not null, primary key (pk));
...
create table study (pk int8 not null, access_control_id varchar(255) not null, access_time timestamp not null, accession_no varchar(255) not null, admission_id varchar(255) not null, completeness int4 not null, created_time timestamp not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state int4 not null, ext_retrieve_aet varchar(255) not null, failed_retrieves int4 not null, modified_time timestamp not null, rejection_state int4 not null, study_size int8 not null, storage_ids varchar(255), study_custom1 varchar(255) not null, study_custom2 varchar(255) not null, study_custom3 varchar(255) not null, study_date varchar(255) not null, study_desc varchar(255) not null, study_id varchar(255) not null, study_iuid varchar(255) not null, study_time varchar(255) not null, updated_time timestamp not null, version int8, dicomattrs_fk int8 not null, accno_issuer_fk int8, admid_issuer_fk int8, patient_fk int8 not null, ref_phys_name_fk int8, primary key (pk));
create table study_query_attrs (pk int8 not null, availability int4, mods_in_study varchar(255), num_instances int4, num_series int4, retrieve_aets varchar(255), cuids_in_study varchar(4000), view_id varchar(255), study_fk int8 not null, primary key (pk));
create table subscription (pk int8 not null, deletion_lock boolean not null, subscriber_aet varchar(255) not null, ups_fk int8 not null, primary key (pk));
create table uidmap (pk int8 not null, uidmap bytea not null, primary key (pk));
create table ups (pk int8 not null, admission_id varchar(255) not null, created_time timestamp not null, expected_end_date_time varchar(255) not null, input_readiness_state int4 not null, performer_aet varchar(255), ups_state int4 not null, replaced_iuid varchar(255) not null, expiration_date_time varchar(255) not null, start_date_time varchar(255) not null, transaction_iuid varchar(255), updated_time timestamp not null, ups_iuid varchar(255) not null, ups_label varchar(255) not null, ups_priority int4 not null, version int8, worklist_label varchar(255) not null, dicomattrs_fk int8 not null, admission_issuer_fk int8, patient_fk int8 not null, station_class_fk int8, station_location_fk int8, station_name_fk int8, ups_code_fk int8, primary key (pk));
create table ups_req (pk int8 not null, accession_no varchar(255) not null, req_proc_id varchar(255) not null, req_service varchar(255) not null, study_iuid varchar(255) not null, accno_issuer_fk int8, req_phys_name_fk int8, ups_fk int8, primary key (pk));
