...
alter table diff_task drop constraint if exists FK_dlrthwe594xvfeta3kyuih3ip;
alter table diff_task_attrs drop constraint if exists FK_72rsx022j2wu9noi6jldvq95r;
alter table diff_task_attrs drop constraint if exists FK_1sbjtesix8hkq310i84lfg0xi;
alter table export_task drop constraint if exists FK_g6atpiywpo2100kn6ovix7uet;
...
alter table mpps drop constraint if exists FK_grl2idmms10qq4lhmh909jxtj;
...
alter table mwl_item drop constraint if exists FK_ot32lpvialton54xqh636c4it;
...
alter table patient drop constraint if exists FK_39gahcxyursxfxe2ucextr65s;
...
alter table patient_id drop constraint if exists FK_oo232lt89k1b5h8mberi9v152;
...
alter table retrieve_task drop constraint if exists FK_mxokt1gw5g1e7rc3ssotvuqix;
...
alter table series_req drop constraint if exists FK_se4n39as61wwf92ggbfc9yglo;
...
alter table stgver_task drop constraint if exists FK_hch5fanx7ejwew2ag2ividq9r;
alter table study drop constraint if exists FK_5w0oynbw061mwu1rr9mrb6kj4;
alter table study drop constraint if exists FK_lp0rdx659kewq8qrqg702yfyv;
...
alter table ups drop constraint if exists FK_61tpdp9aoy98jwiif5wq82ia3;
alter table ups drop constraint if exists FK_8xiqdli1p8cyw1y4hwyqhimcx;
alter table ups drop constraint if exists FK_ak183xmw0sai4jg9lib6m14o2;
alter table ups drop constraint if exists FK_ox3hpmd042ywnww3yh33crcoj;
alter table ups drop constraint if exists FK_gd2hu9idxg6rd71g1i8r8wyjr;
alter table ups drop constraint if exists FK_1retecpk22a2tysmi5o6xcpbh;
alter table ups_req drop constraint if exists FK_gegm1c1ymem7tj2wcm0o7e0pu;
...
drop table diff_task cascade;
drop table diff_task_attrs cascade;
drop table export_task cascade;
...
drop table stgver_task cascade;
